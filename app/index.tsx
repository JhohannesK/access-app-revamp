...
const MOCK_DATA = {
  user: {
    name: 'PRINCE P.',
    profileImage: null, // You'd use require() or URI for actual image
      ...
      <View className="flex-1 bg-background">
        ...
        <BottomNav
          items={[
            ...
            { icon: QrCodeIcon, label: 'Scan' },
            { icon: ArrowLeftRightIcon, label: 'Transfer' },
            { icon: Grid3x3Icon, label: 'Explore' },
          ]}
        />
      </View>
    </>
